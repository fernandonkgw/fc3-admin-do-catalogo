...
public class CategoryAPITest {
    ...
    public void givenAValidCommand_whenCallsCreateCategory_thenShouldReturnCategoryId() throws Exception {
        ...
        verify(createCategoryUseCase, Mockito.times(1)).execute(argThat(cmd ->
    ...
    @Test
    void givenAInvalidWithInvalidId_whenCallsUpdateCategory_thenShouldReturnNotFoundException() throws Exception {
        // given
    ...
    @Test
    void givenValidParams_whenTermDoesntMatchesPrePersisted_shouldReturnEmptyPage() throws Exception {
        // given
