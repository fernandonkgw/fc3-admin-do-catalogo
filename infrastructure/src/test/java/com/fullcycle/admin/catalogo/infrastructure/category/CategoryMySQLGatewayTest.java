...
public class CategoryMySQLGatewayTest {
    ...
    @Test
    void givenAPrePersistedCategoryAndValidCategoryId_whenTryToDeletedIt_shouldDeleteCategory() {
    ...
    @Test
    void givenInvalidVategoryId_whenTryToDeletedIt_shouldDeleteCategory() {
    ...
    @Test
    void givenEmptyCategoriesTable_whenCallFindAll_shouldReturnEmptyPage() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
    ...
    @Test
    void givenPrePersistedCategoriesAndDocAsTerms_whenCallFindAllAndTermsMatchsCategoryName_shouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
    ...
    @Test
    void givenPrePersistedCategoriesAndMaisAssistidaAsTerms_whenCallFindAllAndTermsMatchsCategoryDescription_shouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 1;
    ...
    @Test
    void givenPrePersistedCategories_whenCallExistsByIds_shouldReturnIds() {
        // given
        final var filmes = Category.newCategory("Filmes", "A categoria mais assistida", true);
        final var series = Category.newCategory("Séries", "Uma categoria assistida", true);
        final var documentarios = Category.newCategory("Documentários", "A categoria menos assistida", true);
