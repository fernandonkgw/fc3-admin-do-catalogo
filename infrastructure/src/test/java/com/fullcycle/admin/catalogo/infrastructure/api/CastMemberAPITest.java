...
class CastMemberAPITest {
    ...
    void givenAValidCommand_whenCallsCreateCastMember_shouldReturnItsIdentifier() throws Exception {
        ...
        final var expectedId = CastMemberID.from("ashjgdjshadg");
        ...
        verify(createCastMemberUseCase).execute(argThat(actuamCmd ->
                Objects.equals(expectedName, actuamCmd.name())
                        && Objects.equals(expectedType, actuamCmd.type())
        ));
    }

    @Test
    void givenAnInvalidName_whenCallCreateCastMember_shouldReturnNotification() throws Exception {
        // given
    ...
    void givenAValidCommand_whenCallsUpdateCastMember_shouldReturnItsIdentifier() throws Exception {
        ...
        verify(updateCastMemberUseCase).execute(argThat(actuamCmd ->
                Objects.equals(expectedId.getValue(), actuamCmd.id())
                        && Objects.equals(expectedName, actuamCmd.name())
                        && Objects.equals(expectedType, actuamCmd.type())
        ));
    }
    ...
    @Test
    void givenAnInvalidName_whenCallUpdateCastMember_shouldReturnNotification() throws Exception {
        // given
    ...
    @Test
    void givenAnInvalidId_whenCallUpdateCastMember_shouldReturnNotFound() throws Exception {
        // given
        final var expectedId = CastMemberID.from("123");
