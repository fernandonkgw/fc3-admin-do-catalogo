...
public class GenreE2ETest implements MockDsl {
    ...
    @Test
    void asACatalogAdminIShouldBeAbleToNavigateThruAllCategories() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    void asACatalogAdminIShouldBeAbleToSortAllGenreNameByDesc() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    void asACatalogAdminIShouldNotSeeAnErrorByDeletingNotExistentGenre() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
