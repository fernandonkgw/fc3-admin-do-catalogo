...
public class CreateGenreUseCaseTest extends UseCaseTest {
    ...
    @Test
    void givenAValidCommand_whenCallCreateGenre_shouldReturnGenreId() {
        // given
    ...
    @Test
    void givenAValidCommandWithInactiveGenre_whenCallCreateGenre_shouldReturnGenreId() {
        // given
        final var expectName = "Ação";
    ...
    @Test
    void givenAValidCommandWithCategories_whenCallCreateGenre_shouldReturnGenreId() {
        // given
        final var expectName = "Ação";
        final var expectedIsActive = true;
    ...
    @Test
    void givenAValidCommand_whenCallsCreateCategoryAndSomeCategoriesDoesNotExists_shouldReturnDomainException() {
        // given
    ...
    @Test
    void givenAInvalidCommand_whenCallsCreateCategoryAndSomeCategoriesDoesNotExists_shouldReturnDomainException() {
        // given
        final var filmes = CategoryID.from("456");
        final var series = CategoryID.from("123");
        final var documentarios = CategoryID.from("789");
